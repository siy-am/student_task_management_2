<?php
// general.php - Modularized version
...
// Fetch Tasks - Filter by Category 'Other' (General)
$tasks = [];
$sql = "SELECT * FROM tasks WHERE user_id = $user_id AND category IN ('General', 'Other') ORDER BY $order_by";
...
<head>
    ...
    <title>General Tasks - TaskFlow</title>
    ...
    <div class="dashboard">
        ...
        <main class="main-content">
            <div class="content-header">
                <h1 class="page-title">General Tasks</h1>
            ...
            <div class="task-list-container">
                <?php if (empty($tasks)): ?>
                    <div style="padding: 50px; text-align: center; color: #999;">
                        <i class="fas fa-layer-group" style="font-size: 48px; margin-bottom: 20px; opacity: 0.3;"></i>
                            ...
                            <?php foreach ($tasks as $task): ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        ...
                                        <!-- Local Delete Link -->
                                        <a href="general.php?delete_id=<?php echo $task['id']; ?>" 
