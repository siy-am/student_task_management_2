...
$tasks = [];
$sql = "SELECT * FROM tasks WHERE user_id = $user_id AND category = 'Work' ORDER BY $order_by";
...
<head>
    ...
    <title>Work Tasks - TaskFlow</title>
    ...
    <div class="dashboard">
        ...
        <main class="main-content">
            <div class="content-header">
                <h1 class="page-title">Work Tasks</h1>
                <div class="controls">
            ...
            <div class="task-list-container">
                <?php if (empty($tasks)): ?>
                    <div style="padding: 50px; text-align: center; color: #999;">
                        <i class="fas fa-briefcase" style="font-size: 48px; margin-bottom: 20px; opacity: 0.3;"></i>
                            ...
                            <?php foreach ($tasks as $task): ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        ...
                                        <a href="work.php?delete_id=<?php echo $task['id']; ?>" class="action-btn delete" onclick="return confirm('Delete?');"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
